...
//
// Code generated for Simulink model 'tntc'.
//
// Model version                  : 1.9
// Simulink Coder version         : 24.1 (R2024a) 19-Nov-2023
// C/C++ source code generated on : Thu Nov 21 22:22:13 2024
//
  ...
  namespace matlab
  {
    ...
    void NodeInterface::initialize(int argc, char ** argv)
    {
      try {
        ...
        ROS_INFO("** Starting the model \"tntc\" **\n");

        // initialize the model which will initialize the publishers and subscribers
        rtmSetErrorStatus(tntc_M, (NULL));
        tntc_initialize();
    ...
    boolean_T NodeInterface::getStopRequestedFlag(void)
    {
      ...
      return (!(rtmGetErrorStatus(tntc_M)
                == (NULL)));

#else

      return (!(rtmGetErrorStatus(tntc_M)
                == (NULL)) || rtmGetStopRequested(tntc_M));
    ...
    {
      mRunModel = (rtmGetErrorStatus(tntc_M) ==
                   (NULL));
      while (mRunModel) {
        mBaseRateSem.wait();
